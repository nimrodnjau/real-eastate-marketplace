// Each entry pairs a display name with its ISO 3166-1 alpha-2 code.
// The code is used to load a flag icon from flagcdn.com.
export const COUNTRIES = [
  ...
  { name: 'Congo (DRC)', code: 'cd' }, { name: 'Congo (Republic)', code: 'cg' },
